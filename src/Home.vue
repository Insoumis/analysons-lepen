<template>
  <main class="alp-home">
    ...
    <p class="alp-home__intro">
      ...
      <br>
      <br>
      Ce site a pour objectif d'être <strong>une source de réflexion</strong> pour favoriser l'esprit critique de la population autour du projet mortifère du Front National. C'est un espace en développement permanent qui sera enrichi au fil des prochaines semaines.
    </p>
